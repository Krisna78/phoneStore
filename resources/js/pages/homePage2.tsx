    ...
    return (
        <Layout>
            ...
            <div className="mx-1 mt-3 px-4.5 md:mt-6 lg:mt-9">
                <div className="relative">
                    <div className="flex items-center justify-between align-middle">
                        <h1 className="font-base w-fit border-b-1 border-y-primary py-0.5 text-[10px] text-black md:border-b-2 md:text-[18px] lg:text-[22px]">
                            Pilihan terbaik untuk <span className="font-bold text-primary">Brand</span>
                        </h1>
                        <div className="flex cursor-pointer items-center justify-center gap-1 text-center align-middle">
                ...
                <div className="mt-3 mb-2 grid grid-cols-2 justify-between justify-items-stretch gap-2 md:mt-5 md:grid-cols-3 md:gap-3 lg:grid-cols-4">
                    {[
                        ...
                        <div
                            key={index}
                            className="flex h-[60px] w-full cursor-pointer items-center justify-center rounded-md border-1 border-primary object-contain p-2 md:h-[80px] lg:h-[120px]"
                        >
