      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mb-6 flex items-center">
          <Button
            ...
            className="group flex items-center rounded-md gap-2 text-white bg-blue-500 hover:bg-blue-700 hover:text-white"
          >
                ...
                <div className="mb-4 flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold text-gray-900">
                      Belanja {transaction.date}
                    </h3>
                    <div className="mt-1 flex items-center gap-2">
                      <Badge
                        className={`px-2 py-1 text-xs ${getStatusVariant(transaction.status)}`}
                      >
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="mb-4">
                    ...
                    {transaction.products.map((product, index) => (
                      <div
                        key={index}
                        className="mb-3 flex items-start justify-between last:mb-0"
                      >
