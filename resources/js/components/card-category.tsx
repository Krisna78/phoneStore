...
export default function CategoryCard({ category }: Props) {
    return (
        <Link href={category.href} className="flex flex-col items-center rounded-lg border border-third3 p-3 transition-all hover:shadow-md">
            {/* Gambar kategori */}
            <div className="flex h-[70px] w-[75px] items-center justify-center lg:h-[85px] lg:w-[90px]">
                <img src={category.src} alt={category.alt} className="h-full w-full object-contain" loading="lazy" />
            </div>
